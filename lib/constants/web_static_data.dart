...
body {
            ...
            section button,
            section input#myFile::-webkit-file-upload-button {
                font-size: 1.5rem;
                border: solid black 2px;
                margin: 0.5rem auto;
                padding: 1rem 3rem;
                border-radius: 0 1rem 1rem 1rem;
                box-shadow: 0.25rem 0.25rem 0rem #1c7cca;
            }

            section button:hover,
            section input#myFile::-webkit-file-upload-button:hover {
                box-shadow: 0.25rem 0.25rem 0.2rem #2196f3;
            }
...
<head>
    ...
    <style>
        ...
        section div{
            ...
            padding: 1rem 3rem;
            border-radius: 0 1rem 1rem 1rem;
            box-shadow: .25rem .25rem 0rem #1c7cca;
        }
        section div:hover{
            box-shadow: .25rem .25rem .2rem #2196F3;
        }
        a{
...
String kFileReceivedSuccessfully = '''
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <h1>File Received Successfully</h1>
</body>
</html>
''';
